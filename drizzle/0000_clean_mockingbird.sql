...
CREATE TABLE "users" (
	...
	"role" text DEFAULT 'Ejecutivo' NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
...
ALTER TABLE "rates" ADD CONSTRAINT "rates_carrier_id_entities_id_fk" FOREIGN KEY ("carrier_id") REFERENCES "public"."entities"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "routings" ADD CONSTRAINT "routings_rate_id_rates_id_fk" FOREIGN KEY ("rate_id") REFERENCES "public"."rates"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "invoices" ADD CONSTRAINT "invoices_party_id_entities_id_fk" FOREIGN KEY ("party_id") REFERENCES "public"."entities"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "party_bl_formats" ADD CONSTRAINT "party_bl_formats_party_id_entities_id_fk" FOREIGN KEY ("party_id") REFERENCES "public"."entities"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
